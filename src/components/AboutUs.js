    ...
    return (
        <>
            ...
            <main className='about-us for-add'>
                        ...
                        >
                            ...
                            <div className="info-div" >
                                ...
                                {location.pathname === '/aboutus' ? <>
                                    ...
                                    <p>
                                        At Passive Income Pro, we are dedicated to empowering individuals with the tools and resources needed to achieve financial independence and generate passive income streams. Our mission is to provide innovative solutions and unparalleled support to help you maximize your earning potential and build a sustainable income.   </p>
                                </> : <>
                ...
                {location.pathname === '/aboutus' ? <div className='add '></div> : <></>}
                {location.pathname === '/contactus' ? <div className='add2 '></div> : <></>}
            </main>
